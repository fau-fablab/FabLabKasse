...
class Produkt(object):
    ...
    def add_verkaufseinheit(
        self, verkaufseinheit, preis, basismenge=None, input_mode="DECIMAL"
    ):
        ...
        self.verkaufseinheiten[verkaufseinheit] = {
            "preis": preis,
            "basismenge": basismenge,
        ...
        for l in f.split("\n"):
            ...
            if not (l[0].startswith(" ") or l[0].startswith("\t")):
                ...
                if basismenge == "None":
                    ...
                    basismenge = Decimal(basismenge)
                p.add_verkaufseinheit(
                    verkaufseinheit=l[0].strip(),
    ...
    def __repr__(self):
        return "<%s(name=%s, basiseinheit=%s, basispreis=%s, verkaufseinheiten=%s)>" % (
            ...
            self.name.__repr__(),
            self.basiseinheit.__repr__(),
            self.verkaufseinheiten[self.basiseinheit].__repr__(),
            self.verkaufseinheiten.__repr__(),
        )
