...
class ShoppingBackend(AbstractOfflineShoppingBackend):
    ...
    def __init__(self, cfg):
        categories = [Category(categ_id=7, name="Lasercutter", parent_id=0),
        ...
        AbstractOfflineShoppingBackend.__init__(self, cfg, categories, products, generate_root_category=True)

    def list_clients(self):
        clients = {1: Client(client_id=1, name="dummy 1234", pin="1234", debt=Decimal(13.37), debt_limit=Decimal('Infinity')),
